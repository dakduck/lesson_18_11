...
public class StaxParserSeller {
    ...
    public List<Seller> readConfig(String configFile) {
        ...
        try {
            ...
            while (eventReader.hasNext()) {
                ...
                if (event.isStartElement()) {
                    ...
                    if (startElement.getName().getLocalPart().equals(SELLER)) {
                        item = new Seller();
                    ...
                    if (event.isStartElement()) {
                        if (event.asStartElement().getName().getLocalPart()
                            ...
                            continue;
                                ...
                                .equals(SURNAME)) {
                            event = eventReader.nextEvent();
                            item.setSurname(event.asCharacters().getData());
                            continue;
                        } else if (event.asStartElement().getName().getLocalPart()
                                .equals(ID)) {
                            event = eventReader.nextEvent();
                ...
                if (event.isEndElement()) {
                    ...
                    if (endElement.getName().getLocalPart().equals(SELLER)) {
                        items.add(item);
                    }
                }
